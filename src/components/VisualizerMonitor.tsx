...
import { Crosshair, Play, Pause, SkipForward, SkipBack } from 'lucide-react';
...
export function VisualizerMonitor({
  ...
  return (
    ...
    >
      ...
      {/* Transport Controls */}
      <div
        className="flex items-center justify-center gap-3 px-3 py-2 border-t"
        style={{
          borderColor: theme.panelBorder,
          background: `var(--t-panel-gradient, ${theme.panel})`,
        }}
      >
        <button
          ...
          style={{ borderColor: theme.panelBorder, borderRadius: 'var(--t-radius)' }}
        >
          <SkipBack className="w-3 h-3" style={{ color: `color-mix(in srgb, ${theme.primary} 60%, transparent)` }} />
        </button>
        <button
        ...
        <button
          ...
          style={{ borderColor: theme.panelBorder, borderRadius: 'var(--t-radius)' }}
        >
          <SkipForward className="w-3 h-3" style={{ color: `color-mix(in srgb, ${theme.primary} 60%, transparent)` }} />
        </button>
      </div>
    </motion.div>
  );
